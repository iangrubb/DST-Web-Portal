defmodule PortalDeploymentWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: PortalDeploymentWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/portal_deployment_web/templates",
        namespace: PortalDeploymentWeb
